...
export default function Page() {
  ...
  const [feasibilityForm, setFeasibilityForm] = useState({ consumerNumber: '', districtId: '', districtName: '', sectionId: '', sectionOffice: '', landmark: '', transformerName: '' })
...
requestAnimationFrame(() => {
  ...
  const selectKsebSection = async (sectionId: string) => {
    ...
    setFeasibilityForm((current) => ({ ...current, sectionId, sectionOffice: section?.name ?? '', transformerName: '' }))
