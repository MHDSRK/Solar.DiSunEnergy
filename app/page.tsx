...
export default function Page() {
  ...
  return (
    <main className="relative min-h-dvh overflow-y-auto bg-[#03132f] text-white" aria-label="DiSun Energy International solar calculator">
      ...
      <div className="relative z-10 flex justify-center px-5 pb-8 pt-2">
        <button type="button" onClick={() => setIsCalculatorOpen(true)} className="flex min-h-11 w-full max-w-[245px] items-center justify-center rounded-full bg-[#1260a4] px-7 text-sm font-extrabold tracking-[0.08em] text-white shadow-[0_5px_18px_rgba(18,96,164,.42)] transition-transform hover:scale-[1.03]">CALCULATE</button>
      </div>
      {isCalculatorOpen && (
