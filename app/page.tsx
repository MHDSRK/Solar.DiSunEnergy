...
export default function Page() {
  ...
  const validateAndSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    if (Object.keys(nextErrors).length === 0) calculateSolarResult()
  }
